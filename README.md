...
- Daily Archive levels are wired from `public/assets/scenes/archive/1-7/` through `src/content/dailyArchive.ts`; the calendar selection is deterministic by local `dayNumber % 7`, and daily completions do not write to campaign `completedLevels`.

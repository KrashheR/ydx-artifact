...
- Responsive photo comparator with desktop side-by-side and three mobile-landscape choices: A/B flip, before/after slider, or side-by-side photos with shared zoom/pan; mobile portrait is blocked by a rotate-device gate and is not a playable layout.

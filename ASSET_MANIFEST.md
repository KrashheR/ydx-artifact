...
| archive-scene-package-2026-07-06 | `public/assets/scenes/archive/<level-order>/{1,2,3}.webp` | Daily Archive scene package | production-runtime | owner-provided PNG archive scene folders `1-7` converted to lossless WebP with unchanged 1586x992 dimensions and wired in `src/content/dailyArchive.ts`; source PNGs removed from runtime after conversion |

...
| artifact-state-images-2026-07-05 | `public/assets/artifacts/<campaign-folder>/<level-order>/{open,close,closed}.webp` | artifact state image | generated-derivative | owner-provided PNG artifact images converted to 512x512 lossless WebP |

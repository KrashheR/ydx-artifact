...
`sand-meridian` runtime intake currently uses the original PNG package under `public/assets/scenes/sand-meredian/<level-order>/`:

- `1.png`: left scene, wired to `imageA`.
- `2.png`: right scene, wired to `imageB`.
- `3.png`: markup reference kept in the intake package for later hitbox transcription.
...
| sand-meridian-background | `public/assets/scenes/sand-meredian/background.png` | chapter map background | production-intake | content owner image provided in workspace |
| sand-meridian-package | `public/assets/scenes/sand-meredian/` | campaign scene package | production-intake | content owner package with scene triplets for folders `1-12`; level 13 currently falls back to folder `12` |

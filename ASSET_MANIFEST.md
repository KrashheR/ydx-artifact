...
Artifact state images under `public/assets/artifacts/<campaign-folder>/<level-order>/` were converted on 2026-07-05 from owner-provided PNG sources to lossless WebP and downscaled from 1254x1254 to 1003x1003. The runtime folder keeps only the WebP derivatives; original PNG exports should stay outside runtime folders if preservation is required.
...
| artifact-state-images-2026-07-05 | `public/assets/artifacts/<campaign-folder>/<level-order>/{open,close,closed}.webp` | artifact state image | generated-derivative | owner-provided PNG artifact images converted to lossless WebP and downscaled to 80% dimensions |

...
export function ArtifactFoundToast({ variant }: { variant: ArtifactToastVariant }) {
  ...
  return (
    ...
    <div className="pointer-events-none absolute left-1/2 top-[112px] z-40 -translate-x-1/2">
      <div
        className="flex items-center gap-3 rounded-[10px] px-5 py-3 pl-3.5"
        style={{
          background: "rgba(21,27,24,.86)",
          border: isReplay
            ? "1px solid rgba(111,198,158,.35)"
            : "1px solid rgba(184,138,69,.5)",
      ...
      >
        <div
          ...
          style={
            isReplay
              ? {
                  background: "rgba(111,198,158,.12)",
                  border: "1px solid rgba(111,198,158,.4)",
                }
              : {

...
- `pnpm validate:content` now checks level assets, chapter previews/backgrounds, locale keys, provenance coverage, markup references, known campaign runtime folders, accidental debug-flag usage, A/B image hash mismatch, matching WebP dimensions, normalized hotspot bounds and duplicate hotspot bounds.

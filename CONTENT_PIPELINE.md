...
- Runtime gameplay scene optimization is scripted in `scripts/optimize-scene-assets.ts`. The default pass is dry-run; the 2026-07-03 q97 gated pass replaced six oversized `1.webp` / `2.webp` files and reduced gameplay scene weight from 52.0 MB to 44.4 MB without changing dimensions.

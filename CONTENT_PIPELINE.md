...
- The pending `archive` scene intake under `public/assets/scenes/archive/1-7/` has lossless WebP derivatives generated from the owner-provided PNG files on 2026-07-06. It is not registered in `campaignManifest` until the corresponding campaign/level content is wired.

...
- `magnifiers` (hints) are stored as a non-negative integer without a maximum cap. Level and Daily Archive rewards add to the current balance, and loading or migrating a save preserves large existing balances.

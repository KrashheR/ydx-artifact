...
- **<768px landscape (844×390, 640×360):** mobile comparison can use A/B flip-card, before/after slider, or side-by-side photos with shared zoom/pan. Safe-area insets respected.

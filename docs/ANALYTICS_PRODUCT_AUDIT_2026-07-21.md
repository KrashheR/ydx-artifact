...
Для выбора **нового сеттинга** одной поведенческой аналитики недостаточно. Добавить после кампании короткий необязательный опрос из одного вопроса с 3–4 концептами сеттинга и событием `setting_interest_selected`. Сопоставлять ответ с фактической глубиной и retention, не выдавая награду за конкретный вариант.
